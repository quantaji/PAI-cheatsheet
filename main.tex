...
\input{section/00_pre.tex}
\input{section/01_bayesian_lr.tex}
\input{section/02_gp.tex}
\input{section/03_vi.tex}
\input{section/04_bdl.tex}
\input{section/05_active_learning.tex}
\input{section/06_rl.tex}
